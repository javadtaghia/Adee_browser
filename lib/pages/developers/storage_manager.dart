        ...
        rows.addAll(dataRecords.map((dataRecord) {
          ...
          return DataRow(cells: <DataCell>[
            DataCell(
              SizedBox(
                width: constraints.maxWidth / 3,
                child: Text("", style: textStyle, softWrap: true),
              ),
              onTap: () {
            ...
            DataCell(
              ...
              onTap: () {
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      content: Text("", style: textStyle, softWrap: true),
                    );
                  },
                );
              },
                ...
                DataCell(
                  ...
                  onTap: () {
                    Clipboard.setData(ClipboardData(
                        text: httpAuthCredential.username.toString()));
                  },
                ),
                DataCell(
                  SizedBox(
                  ...
                  onTap: () {
                    Clipboard.setData(ClipboardData(
                        text: httpAuthCredential.password.toString()));
                  },
                ),
                DataCell(IconButton(
                  icon: const Icon(Icons.cancel),
